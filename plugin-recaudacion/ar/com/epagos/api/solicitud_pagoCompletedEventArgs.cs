...
// Type: InfoGov.Plugins.Recaudacion.ar.com.epagos.api.solicitud_pagoCompletedEventArgs
...
public class solicitud_pagoCompletedEventArgs : AsyncCompletedEventArgs
{
  private object[] results;

  internal solicitud_pagoCompletedEventArgs(
    object[] results,
    Exception exception,
    bool cancelled,
    object userState)
