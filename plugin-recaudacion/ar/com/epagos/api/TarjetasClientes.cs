...
// Type: InfoGov.Plugins.Recaudacion.ar.com.epagos.api.TarjetasClientes
...
public class TarjetasClientes
{
  ...
  private TarjetasCliente[] tarjetasField;
  ...
  public TarjetasCliente[] tarjetas
  {
    get => this.tarjetasField;
    set => this.tarjetasField = value;
  }
}
