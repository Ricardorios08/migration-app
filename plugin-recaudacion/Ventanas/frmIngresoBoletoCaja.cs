...
// Type: InfoGov.Plugins.Recaudacion.Ventanas.frmIngresoBoletoCaja
...
public class frmIngresoBoletoCaja : BaseForm
{
  private ExpBoletoCaja experto;
  ...
  public frmIngresoBoletoCaja()
  {
    ...
    try
    {
      this.experto = new ExpBoletoCaja();
  ...
  {
    if (PARAMS.Municipio == "LaPaz" || PARAMS.Municipio == "SanMartín")
      this.mtextNumeBole.Focus();
    else
  ...
  private void InitializeComponent()
  {
    ...
    this.colAdicBole.VisibleIndex = 11;
    this.colAdicBole.Width = 48 /*0x30*/;
    ...
    this.colInteBole.VisibleIndex = 12;
    ...
    this.colExenBole.VisibleIndex = 13;
    ...
    this.colApreBole.VisibleIndex = 14;
    ...
    this.colTotaBole.VisibleIndex = 15;
    ...
    this.colCodiUsua.VisibleIndex = 16 /*0x10*/;
    ...
    this.colQuitarBoleto.VisibleIndex = 17;
    ...
    this.Name = nameof (frmIngresoBoletoCaja);
