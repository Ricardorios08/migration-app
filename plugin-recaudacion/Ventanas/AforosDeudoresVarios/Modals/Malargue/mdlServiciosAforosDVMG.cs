...
// Type: InfoGov.Plugins.Recaudacion.Ventanas.AforosDeudoresVarios.Modals.Malargue.mdlServiciosAforosDVMG
...
#nullable disable
namespace InfoGov.Plugins.Recaudacion.Ventanas.AforosDeudoresVarios.Modals.Malargue;

public class mdlServiciosAforosDVMG : BaseForm
{
  ...
  public ServicioAforoDVMG ServicioSeleccionado { get; private set; }

  public mdlServiciosAforosDVMG(List<ServicioAforoDVMG> servicios)
  {
    this.InitializeComponent();
    this.idPlugin = 28;
    this.serviciosDisponibles = servicios ?? new List<ServicioAforoDVMG>();
  ...
  public ServicioAforoDVMG GetServicioSeleccionado()
  {
    int focusedRowHandle = ((ColumnView) this.gridViewServicios).FocusedRowHandle;
    return !((ColumnView) this.gridViewServicios).IsDataRow(focusedRowHandle) ? (ServicioAforoDVMG) null : ((BaseView) this.gridViewServicios).GetRow(focusedRowHandle) as ServicioAforoDVMG;
  }

  private void BtnSeleccionar_Click(object sender, EventArgs e)
  {
    ServicioAforoDVMG servicioSeleccionado = this.GetServicioSeleccionado();
  ...
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (mdlServiciosAforosDVMG));
    ...
    this.Name = nameof (mdlServiciosAforosDVMG);
