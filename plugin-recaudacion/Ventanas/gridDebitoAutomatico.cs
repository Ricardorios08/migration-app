...
// Type: InfoGov.Plugins.Recaudacion.Ventanas.gridDebitoAutomatico
...
public class gridDebitoAutomatico : ABMForm
{
  ...
  private GridColumn colNumeSucu;
  private GridColumn colNumeCuenta;
  private GridColumn colCbu;

  public gridDebitoAutomatico()
    : base((ABMDetailControl) new detailDebitoAutomatico(), (ABMExpert) new ExpDebitoAutomatico(), typeof (DebitoAutomatico))
  {
    this.InitializeComponent();
    this.inicializar(this.gridView1, "Débito Automático", "Débito Automático");
    this.EntityIdProperty = "CuenCtct";
  }
  ...
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (gridDebitoAutomatico));
    this.gridControl1 = new GridControl();
    this.gridView1 = new GridView();
    this.colCodiOfic = new GridColumn();
    this.colCuenCtct = new GridColumn();
    this.colNumeSucu = new GridColumn();
    this.colNumeCuenta = new GridColumn();
    this.colCbu = new GridColumn();
    ...
    this.colCodiOfic.Caption = "Cód. Ofic.";
    this.colCodiOfic.FieldName = "CodiOficStr";
    this.colCodiOfic.Name = "colCodiOfic";
    this.colCodiOfic.Visible = true;
    this.colCodiOfic.VisibleIndex = 0;
    this.colCodiOfic.Width = 97;
    ...
    this.colCuenCtct.Width = 163;
    this.colNumeSucu.Caption = "Nro. Sucursal";
    this.colNumeSucu.FieldName = "NumeSucu";
    this.colNumeSucu.Name = "colNumeSucu";
    this.colNumeSucu.Visible = true;
    this.colNumeSucu.VisibleIndex = 2;
    this.colNumeSucu.Width = 163;
    this.colNumeCuenta.Caption = "Nro. Cuenta";
    this.colNumeCuenta.FieldName = "NumeCuenta";
    this.colNumeCuenta.Name = "colNumeCuenta";
    this.colNumeCuenta.Visible = true;
    this.colNumeCuenta.VisibleIndex = 3;
    this.colNumeCuenta.Width = 163;
    this.colCbu.Caption = "Cbu";
    this.colCbu.FieldName = "Cbu";
    this.colCbu.Name = "colCbu";
    this.colCbu.Visible = true;
    this.colCbu.VisibleIndex = 4;
    this.colCbu.Width = 166;
    this.AutoScaleDimensions = new SizeF(6f, 13f);
    this.AutoScaleMode = AutoScaleMode.Font;
    this.ClientSize = new Size(777, 519);
    this.Controls.Add((Control) this.gridControl1);
    this.Name = nameof (gridDebitoAutomatico);
    this.Text = nameof (gridDebitoAutomatico);
