...
// Type: InfoGov.Plugins.Recaudacion.Ventanas.frmMostrarIngresoMultipleRV
...
public class frmMostrarIngresoMultipleRV : BaseForm
{
  private readonly BoletoGrupo grupo;
  private ExpIngresoMultipleRV expIngreso;
  ...
  public frmMostrarIngresoMultipleRV(BoletoGrupo gp)
  {
    this.InitializeComponent();
    this.grupo = gp;
    this.hoy = Misc.Now();
    this.expIngreso = new ExpIngresoMultipleRV();
  ...
  private void Configuraciones() => this.mtbCodiBarra.MaxLength = 43;

  private void FocusControlIngresoPago() => this.mtbCodiBarra.Focus();
  ...
  private void AgregarBoleto(bool codiBar = false)
  {
    ...
    if (codiBar)
    {
      if (this.mtbCodiBarra.Text.Length == 42)
      {
        if (this.mtbCodiBarra.Text.Substring(0, 4) == "5555" && this.mtbCodiBarra.Text.Substring(14, 2) == "06")
        {
          int num1 = this.experto.BuscarCodiInte();
          string CodiConc = string.Empty;
          if (num1 != 0)
            CodiConc = this.experto.BuscarCodiConcInte(num1);
          int num2 = int.Parse(this.mtbCodiBarra.Text.Substring(16 /*0x10*/, 2));
          ...
          string mensaje1 = this.experto.ComprobarCodiDeva(this.mtbCodiBarra.Text.Substring(4, 8));
          ...
          long CucuPers = this.experto.BuscarCPDV(this.mtbCodiBarra.Text.Substring(4, 8));
          ...
          int num4 = int.Parse(this.mtbCodiBarra.Text.Substring(20, 2));
          int num5 = num4 < 15 ? num3 : (num4 <= 0 || num4 > 50 ? 1900 + num4 : 2000 + num4);
          if (int.Parse(this.mtbCodiBarra.Text.Substring(20, 2)) >= 15)
          {
            string mensaje3 = this.experto.PagadoInternetRivadavia(CucuPers, this.mtbCodiBarra.Text.Substring(4, 8), num5, int.Parse(this.mtbCodiBarra.Text.Substring(22, 2)), int.Parse(this.mtbCodiBarra.Text.Substring(24, 2)), num1);
          ...
          string FeveBole = $"{(int.Parse(this.mtbCodiBarra.Text.Substring(34, 2)) <= 0 || int.Parse(this.mtbCodiBarra.Text.Substring(34, 2)) > 50 ? "19" : "20")}{this.mtbCodiBarra.Text.Substring(34, 2)}-{this.mtbCodiBarra.Text.Substring(36, 2)}-{this.mtbCodiBarra.Text.Substring(38, 2)}";
          string DetaBoleInternet = string.Empty;
          if (int.Parse(this.mtbCodiBarra.Text.Substring(20, 2)) >= 15)
            DetaBoleInternet = "SERVICIO DE CONECTIVIDAD";
          else if (int.Parse(this.mtbCodiBarra.Text.Substring(20, 2)) == 0)
          {
            switch (this.mtbCodiBarra.Text.Substring(22, 4))
            {
              case "0121":
          ...
          string mensaje4 = this.experto.CrearNuevoBoleto(num3, NumeBole, CucuPers, FeveBole, DetaBoleInternet, num5, CodiConc, num1, this.mtbCodiBarra.Text);
          if (!string.IsNullOrEmpty(mensaje4))
          {
            new frmMensaje((Form) this).mostrarError(mensaje4);
            return;
          }
          this.mtbPeriBole.IntText = num3;
          this.mtbNumeBole.IntText = NumeBole;
        }
        else
        {
      ...
      else if (this.mtbCodiBarra.Text.Length == 8)
      {
        string CodiBarra = this.experto.BuscarCodiBoleCone(this.mtbCodiBarra.Text);
        ...
        if (CodiBarra.Substring(0, 4) == "5555" && CodiBarra.Substring(14, 2) == "06")
        {
          ...
          this.mtbPeriBole.IntText = num8;
          this.mtbNumeBole.IntText = NumeBole;
        }
        else if (CodiBarra.Substring(0, 4) == "5555" && CodiBarra.Substring(15, 1) == "8")
        {
          int CodiCort = int.Parse(this.mtbCodiBarra.Text);
          ...
          this.mtbPeriBole.IntText = num10;
          this.mtbNumeBole.IntText = NumeBole;
        }
        else
        {
      ...
      else if (this.mtbCodiBarra.Text.Length == 12)
      {
      ...
      else if (this.mtbCodiBarra.Text.Length == 18)
      {
        this.mtbPeriBole.IntText = 2000 + int.Parse(this.mtbCodiBarra.Text.Substring(0, 2));
        this.mtbNumeBole.IntText = int.Parse(this.mtbCodiBarra.Text.Substring(4, 6));
      }
      else if (this.mtbCodiBarra.Text.Length == 43)
      {
        this.mtbPeriBole.IntText = int.Parse(this.mtbCodiBarra.Text.Substring(4, 4));
        this.mtbNumeBole.IntText = int.Parse(this.mtbCodiBarra.Text.Substring(8, 8));
      }
      else
      {
  ...
  {
    int length = this.mtbCodiBarra.Text.Length;
    int num;
    switch (length)
    {
      case 8:
  ...
  private void InitializeComponent()
  {
    ...
    this.Name = nameof (frmMostrarIngresoMultipleRV);
    this.ShowIcon = false;
