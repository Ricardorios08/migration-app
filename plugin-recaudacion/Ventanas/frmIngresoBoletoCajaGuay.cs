...
// Type: InfoGov.Plugins.Recaudacion.Ventanas.frmIngresoBoletoCajaGuay
...
public class frmIngresoBoletoCajaGuay : BaseForm
{
  private ExpBoletoCajaGuay experto;
  ...
  private GridColumn colNuchFopaStr;
  ...
  public frmIngresoBoletoCajaGuay()
  {
    ...
    try
    {
      this.experto = new ExpBoletoCajaGuay();
      this.labelRecaudador.Text = this.experto.getEntidadRecaudadora().ToUpper();
  ...
  private void AgregarBoleto(bool codiBar = false)
  {
    ...
    if (codiBar)
    {
      this.mtextPeriBole.IntText = int.Parse(this.mtextCodiBarra.Text.Substring(3, 4));
      this.mtextNumeBole.IntText = int.Parse(this.mtextCodiBarra.Text.Substring(7, 9));
    }
    ...
    else
    {
      try
      {
        ...
        this.experto.grupoControlado(this.mdateFecha.Value);
  ...
  private void ConfiguracionesPorMunicipio() => this.mtextCodiBarra.MaxLength = 54;
  ...
  private void gridView2_RowClick(object sender, RowClickEventArgs e)
  {
    ...
    this.FopaSeleccionada.NuchFopaStr = string.Empty;
  ...
  private void gridView2_CellValueChanged(object sender, CellValueChangedEventArgs e)
  {
    ...
    this.formasPagoUsadas.Find((Predicate<FormaPago>) (x => x.CodiTipa == row.CodiTipa)).NuchFopaStr = this.formasPagoUsadas.Find((Predicate<FormaPago>) (x => x.CodiTipa == row.CodiTipa)).NuchFopaStr.Trim();
  ...
  {
    bool sinNumeOper = false;
    this.formasPagoUsadas.ForEach((Action<FormaPago>) (x =>
    {
      if (!string.IsNullOrEmpty(x.NuchFopaStr.Trim()))
        return;
      sinNumeOper = true;
    }));
    if (sinNumeOper)
    {
      new frmMensaje((Form) this).mostrarInformación("El número de operación es obligatorio.");
    }
    else
    {
      string NumerosOperacion = string.Empty;
      this.formasPagoUsadas.ForEach((Action<FormaPago>) (x =>
      {
        NumerosOperacion = $"{NumerosOperacion}'{x.NuchFopaStr}'";
        NumerosOperacion += ",";
      }));
      NumerosOperacion = this.experto.ControlarNumerosOperacion(NumerosOperacion.Substring(0, NumerosOperacion.Length - 1));
      if (!string.IsNullOrEmpty(NumerosOperacion))
        new frmMensaje((Form) this).mostrarError(NumerosOperacion);
  ...
  private void InitializeComponent()
  {
    ...
    this.colNuchFopaStr = new GridColumn();
    ...
    this.metroPanel6.Location = new Point(696, 3);
    this.metroPanel6.Name = "metroPanel6";
    this.metroPanel6.Size = new Size(309, 169);
    ...
    this.lblFaltaPago.Location = new Point(226, 86);
    ...
    this.lblFalta.Location = new Point(226, 62);
    ...
    this.mdtVuelto.Location = new Point(68, 102);
    ...
    this.mdtPaga.Location = new Point(68, 71);
    ...
    this.mdtTotal.Location = new Point(68, 40);
    ...
    this.lblVuelto.Location = new Point(8, 102);
    ...
    this.colNuchFopaStr.Caption = "Nº Operación";
    this.colNuchFopaStr.FieldName = "NuchFopaStr";
    this.colNuchFopaStr.Name = "colNuchFopaStr";
    this.colNuchFopaStr.Visible = true;
    this.colNuchFopaStr.VisibleIndex = 2;
    this.colNuchFopaStr.Width = 175;
    ...
    this.mtextNumeBole.Location = new Point(556, 42);
    ...
    this.mtextNumeBole.Size = new Size(86, 23);
    ...
    this.btnAgregar.Location = new Point(654, 42);
    ...
    this.mtextPeriBole.Size = new Size(105, 23);
    ...
    this.labelRecaudador.Text = "metroLabel3";
    ...
    this.metroLabel1.Text = "Fecha de Envio";
    ...
    this.Name = nameof (frmIngresoBoletoCajaGuay);
