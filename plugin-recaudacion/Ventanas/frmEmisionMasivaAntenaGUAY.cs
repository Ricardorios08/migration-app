...
// Type: InfoGov.Plugins.Recaudacion.Ventanas.frmEmisionMasivaAntenaGUAY
...
public class frmEmisionMasivaAntenaGUAY : FRMForm
{
  ...
  public frmEmisionMasivaAntenaGUAY()
    : base("Emision masiva de Antena", "Emision masiva de Antena", typeof (ExpEmisionMasivaAntenasGUAY))
  {
  ...
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (frmEmisionMasivaAntenaGUAY));
    ...
    this.Name = nameof (frmEmisionMasivaAntenaGUAY);
    this.Text = "Emision Masiva de Antena";
