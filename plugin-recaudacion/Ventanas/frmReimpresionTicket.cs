...
// Type: InfoGov.Plugins.Recaudacion.Ventanas.frmReimpresionTicket
...
public class frmReimpresionTicket : BaseForm
{
  ...
  private void btnImprimir_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        BoletoCaja boleto = this.expImpTicket.ObtenerBoletoImpresion(this.mibPeriodo.IntText, this.mibNumeBole.IntText);
  ...
  private void InitializeComponent()
  {
    ...
    this.Name = nameof (frmReimpresionTicket);
