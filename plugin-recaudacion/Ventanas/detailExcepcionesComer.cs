...
// Type: InfoGov.Plugins.Recaudacion.Ventanas.detailExcepcionesComer
...
public class detailExcepcionesComer : ABMDetailControl
{
  ...
  {
    ExcepcionesComer excepcionesComer = (ExcepcionesComer) enti;
    if (excepcionesComer == null)
    {
      this.LimpiarCampos();
    }
    else
    {
      this.CuentaText.IntText = excepcionesComer.CodiCome;
      this.ExcepcionEB.Entity = (Entity) this.EM.Get<Excepcion>(new ID("CodiExce", (object) excepcionesComer.CodiExce));
      this.FechFinText.Date = excepcionesComer.FfexCome;
      this.ExpedienteText.Text = excepcionesComer.ExexCome;
      this.MotivoText.Text = excepcionesComer.MoexCome;
      this.BuscarHistorial(excepcionesComer.CodiCome);
      if (PARAMS.Municipio == "SanMartín")
        this.BuscarContactos(excepcionesComer.CodiCome);
    }
  }

  protected override Entity LoadEntity()
  {
    return (Entity) new ExcepcionesComer()
    {
      CodiCome = this.CuentaText.IntText,
      CodiExce = (this.ExcepcionEB.Entity != null ? (short) ((Excepcion) this.ExcepcionEB.Entity).CodiExce : (short) 0),
      FfexCome = this.FechFinText.Date,
      ExexCome = this.ExpedienteText.Text,
      MoexCome = this.MotivoText.Text
    };
  }
  ...
  private void BuscarHistorial(int CodiCome)
  {
    this.gridHistorial.DataSource = (object) ((ExpExcepcionesComer) this.Expert).BuscarHistorial(CodiCome);
    ((Control) this.gridHistorial).Refresh();
  }

  private void BuscarContactos(int CodiCome)
  {
    this.gridContactos.DataSource = (object) this.expContacto.ListarContactos(2, CodiCome.ToString());
    ((Control) this.gridContactos).Refresh();
  }
  ...
  private void InitializeComponent()
  {
    ...
    this.metroLabel4.Location = new Point(408, 15);
    ...
    ((Control) this.gridHistorial).Location = new Point(408, 48 /*0x30*/);
    ...
    ((Control) this.gridHistorial).TabIndex = 102;
    ...
    this.MotivoText.Location = new Point(129, 160 /*0xA0*/);
    ...
    this.metroLabel3.Location = new Point(33, 164);
    ...
    this.ExcepcionEB.Location = new Point(129, 55);
    ...
    this.FechFinText.Location = new Point(129, 88);
    ...
    this.CuentaText.Location = new Point(129, 22);
    this.CuentaText.MaxLength = 4;
    this.CuentaText.Name = "CuentaText";
    this.CuentaText.Size = new Size(84, 23);
    this.CuentaText.TabIndex = 92;
    this.CuentaText.TabStop = false;
    ((Control) this.gridContactos).Location = new Point(886, 48 /*0x30*/);
    ...
    ((Control) this.gridContactos).TabIndex = 105;
    ...
    this.lblContactos.Location = new Point(886, 15);
    this.lblContactos.Name = "lblContactos";
    this.lblContactos.Size = new Size(311, 23);
    this.lblContactos.TabIndex = 104;
    ...
    this.Name = nameof (detailExcepcionesComer);
