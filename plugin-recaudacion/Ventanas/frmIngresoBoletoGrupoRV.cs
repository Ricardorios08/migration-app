...
// Type: InfoGov.Plugins.Recaudacion.Ventanas.frmIngresoBoletoGrupoRV
...
public class frmIngresoBoletoGrupoRV : FRMForm
{
  private ExpBoletoGrupoRV expGrupo = new ExpBoletoGrupoRV();
  private ExpBoletoCajaRV experto = new ExpBoletoCajaRV();
  ...
  public frmIngresoBoletoGrupoRV()
  ...
  private void btnAgregarMulti_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      if (row != null && row.FeenAcpa > DateTime.MinValue && row.NumeAcpa > 0)
      {
        if (new frmMostrarIngresoMultipleRV(row).ShowDialog() != DialogResult.OK)
          return;
        this.ResetearGrupoActual();
  ...
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (frmIngresoBoletoGrupoRV));
    ...
    this.separator1.Size = new Size(2478, 2);
    ...
    this.panFormulario.Location = new Point(0, 183);
    ...
    this.panAgregarBoleto.Location = new Point(0, 334);
    ...
    this.panAgregarBoleto.TabIndex = 5;
    ...
    this.Controls.Add((Control) this.panBoletosAgregados);
    this.Controls.Add((Control) this.panTotalesBoletos);
    this.Controls.Add((Control) this.panAgregarBoleto);
    this.Controls.Add((Control) this.panFormulario);
    this.Controls.Add((Control) this.panGrupos);
    this.Name = nameof (frmIngresoBoletoGrupoRV);
    this.Text = "Ingreso de Boletos";
    this.Controls.SetChildIndex((Control) this.panel1, 0);
    this.Controls.SetChildIndex((Control) this.panGrupos, 0);
    this.Controls.SetChildIndex((Control) this.panFormulario, 0);
    this.Controls.SetChildIndex((Control) this.panAgregarBoleto, 0);
    this.Controls.SetChildIndex((Control) this.panTotalesBoletos, 0);
    this.Controls.SetChildIndex((Control) this.panBoletosAgregados, 0);
