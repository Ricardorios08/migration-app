...
// Type: InfoGov.Plugins.Recaudacion.Reportes.Tasas.Cupones
...
public class Cupones : XtraReport
{
  ...
  private CalculatedField TotalTasas;

  public Cupones() => this.InitializeComponent();
  ...
  private void InitializeComponent()
  {
    ...
    this.TotalTasas = new CalculatedField();
    ...
    ((XRControl) this.TableDeta).LocationFloat = new PointFloat(1f, 122.2084f);
    ...
    {
      new XRBinding("Text", (object) null, "FeveLita", "{0:dd/MM/yyyy}")
    });
    ...
    ((XRControl) this.lbFecha).Text = "VENCIMIENTO";
    ...
    ((XRControl) this.xrTable1).SizeF = new SizeF(763.5875f, 25f);
    ...
    ((XRControl) this.xrTableRow1).StylePriority.UseTextAlignment = false;
    ((XRControl) this.xrTableRow1).TextAlignment = (TextAlignment) 32 /*0x20*/;
    this.xrTableRow1.Weight = 1.0;
    ((XRControl) this.xrTableCell1).Name = "xrTableCell1";
    ((XRControl) this.xrTableCell1).Text = "TASAS";
    this.xrTableCell1.Weight = 1.0;
    ((XRControl) this.xrTableCell6).Name = "xrTableCell6";
    ((XRControl) this.xrTableCell6).Text = "BONIFICACIÓN/DESCUENTO";
    ...
    ((XRControl) this.xrTable2).SizeF = new SizeF(763.5874f, 25f);
    ...
    ((XRControl) this.xrTableRow2).StylePriority.UseTextAlignment = false;
    ((XRControl) this.xrTableRow2).TextAlignment = (TextAlignment) 32 /*0x20*/;
    this.xrTableRow2.Weight = 1.0;
    ((XRControl) this.xrTableCell10).DataBindings.AddRange(new XRBinding[1]
    {
      new XRBinding("Text", (object) null, "TotalTasas", "{0:n}")
    });
    ...
    {
      new XRBinding("Text", (object) null, "DescLita", "{0:n}")
    });
    ...
    {
      new XRBinding("Text", (object) null, "RecaBole", "{0:n}")
    });
    ...
    {
      new XRBinding("Text", (object) null, "ToltalP", "{0:n}")
    });
    ...
    ((XRControl) this.lbFechaAnual).Text = "xrLabel22";
    ...
    ((XRControl) this.xrLabel24).LocationFloat = new PointFloat(172.621f, 112.0417f);
    ...
    ((XRControl) this.TableTitu).LocationFloat = new PointFloat(1.079315f, 100.0417f);
    ...
    this.ToltalP.Expression = "[TasaGral] + [InfUrbana] + [AlPublico] + [SobrTasaAnt] + [SobrSupClan] + [ServAgua] + [BombLita] - [DescLita] + [RecaBole] + [CEmision]";
    this.ToltalP.Name = "ToltalP";
    this.TotalTasas.Expression = "[TasaGral] + [InfUrbana] + [AlPublico] + [SobrTasaAnt] + [SobrSupClan] + [ServAgua] + [BombLita]";
    this.TotalTasas.Name = "TotalTasas";
    this.objectDataSource1.DataSource = (object) typeof (CuponTasa);
    ...
    this.CalculatedFields.AddRange(new CalculatedField[3]
    {
      this.TotalPagar,
      this.ToltalP,
      this.TotalTasas
