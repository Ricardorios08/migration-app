...
// Type: InfoGov.Plugins.Recaudacion.Reportes.Tasas.SubRubrosComercio
...
public class SubRubrosComercio : XtraReport
{
  ...
  public SubRubrosComercio() => this.InitializeComponent();
  ...
  private void InitializeComponent()
  {
    ...
    this.objectDataSource1.DataSource = (object) typeof (DTOSubRubros);
