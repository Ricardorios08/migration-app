...
// Type: InfoGov.Plugins.Recaudacion.Reportes.Tasas.CuponTasa
...
public class CuponTasa
{
  public Decimal TasaGral { get; set; }

  public Decimal InfUrbana { get; set; }

  public Decimal AlPublico { get; set; }

  public Decimal SobrTasaAnt { get; set; }

  public Decimal SobrSupClan { get; set; }

  public Decimal ServAgua { get; set; }
