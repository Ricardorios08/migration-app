...
// Type: InfoGov.Plugins.Recaudacion.Reportes.Maipu.ReimpresionPP.irepReimpresionPPMP
...
public class irepReimpresionPPMP : InfoGovReport
{
  ...
  public irepReimpresionPPMP()
    : base(nameof (irepReimpresionPPMP), "Reimprimir Plan Pago")
  {
