...
// Type: InfoGov.Plugins.Recaudacion.Reportes.Maipu.ConsultaBoleto.irepConsultaBoletoMP
...
public class irepConsultaBoletoMP : InfoGovReport
{
  ...
  public irepConsultaBoletoMP()
    : base(nameof (irepConsultaBoletoMP), "Consulta Boleto")
  {
