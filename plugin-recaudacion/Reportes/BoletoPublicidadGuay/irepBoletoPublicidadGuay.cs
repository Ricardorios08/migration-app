...
// Type: InfoGov.Plugins.Recaudacion.Reportes.BoletoPublicidadGuay.irepBoletoPublicidadGuay
...
public class irepBoletoPublicidadGuay : InfoGovReport
{
  ...
  public irepBoletoPublicidadGuay()
    : base(nameof (irepBoletoPublicidadGuay), "Boleto Publicidad")
  {
  ...
  {
    ((XtraReportBase) ((SubreportBase) this.xrSubreport1).ReportSource).DataSource = (object) ((DTOBoletoPublicidadGuay) ((XtraReportBase) this).GetCurrentRow()).cupones;
  }
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (irepBoletoPublicidadGuay));
    ...
    ((XRControl) this.PageHeader).Controls.AddRange(new XRControl[16 /*0x10*/]
    {
    ...
    ((XRControl) this.xrPanel5).Borders = (BorderSide) 14;
    ...
    {
      new ExpressionBinding("BeforePrint", "Text", "[DeudLipuStr]")
    });
    ...
    ((XRControl) this.xrPanel1).SizeF = new SizeF(612.1377f, 80f);
    ...
    ((XRControl) this.xrLabel11).LocationFloat = new PointFloat(65.96999f, 137.2693f);
    this.xrLabel11.Multiline = true;
    ((XRControl) this.xrLabel11).Name = "xrLabel11";
    ((XRControl) this.xrLabel11).Padding = new PaddingInfo(2, 2, 0, 0, 100f);
    ((XRControl) this.xrLabel11).SizeF = new SizeF(548.6275f, 40.69646f);
    ((XRControl) this.xrLabel11).StylePriority.UseBorders = false;
    ((XRControl) this.xrLabel11).StylePriority.UseFont = false;
    ((XRControl) this.xrLabel11).Text = "Calle: [CallLipu] Nro: [NucaLipu] Barrio: [BarrLipu] Mza: [ManzLipu] Casa: [CasaLipu][UbicLipu]\r\nLoc: [LocaLipu] CP: [CopoLipu]";
    ...
    ((XRControl) this.xrLabel9).LocationFloat = new PointFloat(185.7004f, 113.2693f);
    ((XRControl) this.xrLabel9).Name = "xrLabel9";
    ((XRControl) this.xrLabel9).Padding = new PaddingInfo(2, 2, 0, 0, 100f);
    ((XRControl) this.xrLabel9).SizeF = new SizeF(428.8973f, 23.99989f);
    ...
    ((XRControl) this.xrLabel8).LocationFloat = new PointFloat(129.5097f, 113.2693f);
    ((XRControl) this.xrLabel8).Name = "xrLabel8";
    ((XRControl) this.xrLabel8).Padding = new PaddingInfo(2, 2, 0, 0, 100f);
    ((XRControl) this.xrLabel8).SizeF = new SizeF(56.17366f, 24.00009f);
    ...
    ((XRControl) this.xrLabel7).LocationFloat = new PointFloat(65.96999f, 113.2693f);
    ((XRControl) this.xrLabel7).Name = "xrLabel7";
    ((XRControl) this.xrLabel7).Padding = new PaddingInfo(2, 2, 0, 0, 100f);
    ((XRControl) this.xrLabel7).SizeF = new SizeF(63.4f, 23.99998f);
    ...
    ((XRControl) this.xrLabel6).LocationFloat = new PointFloat(2.460006f, 113.2693f);
    ((XRControl) this.xrLabel6).Name = "xrLabel6";
    ((XRControl) this.xrLabel6).Padding = new PaddingInfo(2, 2, 0, 0, 100f);
    ((XRControl) this.xrLabel6).SizeF = new SizeF(63.5f, 23.99998f);
    ...
    {
      new ExpressionBinding("BeforePrint", "Text", "[OrdeLipu]")
    });
    ((XRControl) this.xrLabel5).Font = new Font("Arial", 9f);
    ((XRControl) this.xrLabel5).LocationFloat = new PointFloat(515.3469f, 80f);
    ((XRControl) this.xrLabel5).Name = "xrLabel5";
    ((XRControl) this.xrLabel5).Padding = new PaddingInfo(2, 2, 0, 0, 100f);
    ((XRControl) this.xrLabel5).SizeF = new SizeF(99.25079f, 33.26934f);
    ...
    ((XRControl) this.xrLabel4).LocationFloat = new PointFloat(454.4408f, 80f);
    ((XRControl) this.xrLabel4).Name = "xrLabel4";
    ((XRControl) this.xrLabel4).Padding = new PaddingInfo(2, 2, 0, 0, 100f);
    ((XRControl) this.xrLabel4).SizeF = new SizeF(60.90616f, 33.26934f);
    ...
    ((XRControl) this.xrLabel3).LocationFloat = new PointFloat(2.460008f, 80f);
    this.xrLabel3.Multiline = true;
    ((XRControl) this.xrLabel3).Name = "xrLabel3";
    ((XRControl) this.xrLabel3).Padding = new PaddingInfo(2, 2, 0, 0, 100f);
    ((XRControl) this.xrLabel3).SizeF = new SizeF(451.5988f, 33.26934f);
    ...
    ((XRControl) this.xrLabel3).Text = "PUBLICIDAD Y PROPAGANDA";
    ...
    ((XRControl) this.xrLabel13).LocationFloat = new PointFloat(65.96662f, 177.9658f);
    this.xrLabel13.Multiline = true;
    ((XRControl) this.xrLabel13).Name = "xrLabel13";
    ((XRControl) this.xrLabel13).Padding = new PaddingInfo(2, 2, 0, 0, 100f);
    ((XRControl) this.xrLabel13).SizeF = new SizeF(548.6309f, 72.00002f);
    ((XRControl) this.xrLabel13).StylePriority.UseBorders = false;
    ((XRControl) this.xrLabel13).StylePriority.UseFont = false;
    ((XRControl) this.xrLabel13).Text = "Calle: [CallLipuReal] Nro: [NucaLipuReal] Barrio: [BarrLipuReal] Mza: [ManzLipuReal]\r\nCasa: [CasaLipuReal][UbicLipuReal]\r\nLoc: [LocaLipuReal] CP: [CopoLipuReal]\r\n";
    ...
    ((XRControl) this.xrPictureBox2).LocationFloat = new PointFloat(384.46f, 0.0f);
    ((XRControl) this.xrPictureBox2).Name = "xrPictureBox2";
    ((XRControl) this.xrPictureBox2).SizeF = new SizeF(230.1375f, 136.6005f);
    ...
    ((XRControl) this.xrRichText3).SizeF = new SizeF(382f, 136.6005f);
    ...
    ((SubreportBase) this.xrSubreport1).ReportSource = (XtraReport) new CuponesPublicidad();
    ((XRControl) this.xrSubreport1).SizeF = new SizeF(771.8741f, 23f);
    this.objectDataSource1.DataSource = (object) typeof (DTOBoletoPublicidadGuay);
