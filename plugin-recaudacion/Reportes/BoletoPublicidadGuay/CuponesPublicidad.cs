...
// Type: InfoGov.Plugins.Recaudacion.Reportes.BoletoPublicidadGuay.CuponesPublicidad
...
public class CuponesPublicidad : XtraReport
{
  ...
  public CuponesPublicidad() => this.InitializeComponent();
  ...
  private void InitializeComponent()
  {
    ...
    {
      new XRBinding("Text", (object) null, "FeveLipu")
    });
    ...
    {
      new XRBinding("Text", (object) null, "ImpoLipu")
    });
    ...
    {
      new XRBinding("Text", (object) null, "DescLipu")
    });
    ...
    this.ToltalP.Expression = "[ImpoLipu] - [DescLipu] + [RecaBole] + [CEmision]";
    this.ToltalP.Name = "ToltalP";
    this.objectDataSource1.DataSource = (object) typeof (CuponPublicidad);
