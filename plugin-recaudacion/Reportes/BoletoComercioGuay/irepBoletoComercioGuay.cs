...
// Type: InfoGov.Plugins.Recaudacion.Reportes.BoletoComercioGuay.irepBoletoComercioGuay
...
public class irepBoletoComercioGuay : InfoGovReport
{
  ...
  public irepBoletoComercioGuay()
    : base(nameof (irepBoletoComercioGuay), "Boleto Comercio")
  {
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (irepBoletoComercioGuay));
