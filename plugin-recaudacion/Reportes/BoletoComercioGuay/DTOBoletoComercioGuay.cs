...
// Type: InfoGov.Plugins.Recaudacion.Reportes.BoletoComercioGuay.DTOBoletoComercioGuay
...
public class DTOBoletoComercioGuay
{
  public DTOBoletoComercioGuay()
  {
    this.cupaux = new List<CuponComercioAux>();
    this.cupones = new List<CuponComercio>();
    this.subrubros = new List<DTOSubRubros>();
  }
  ...
  public List<CuponComercio> cupones { get; set; }

  public List<CuponComercioAux> cupaux { get; set; }

  public List<DTOSubRubros> subrubros { get; set; }
