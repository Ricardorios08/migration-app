...
// Type: InfoGov.Plugins.Recaudacion.Reportes.BoletoCementerioGuay.CuponesCementerio
...
public class CuponesCementerio : XtraReport
{
  ...
  public CuponesCementerio() => this.InitializeComponent();
  ...
  private void InitializeComponent()
  {
    ...
    ((XRControl) this.xrBarCode3).LocationFloat = new PointFloat(197.7705f, 64.12633f);
    ...
    ((XRControl) this.xrLabel24).LocationFloat = new PointFloat(178.5793f, 104.2084f);
    ...
    this.objectDataSource1.DataSource = (object) typeof (CuponCementerio);
