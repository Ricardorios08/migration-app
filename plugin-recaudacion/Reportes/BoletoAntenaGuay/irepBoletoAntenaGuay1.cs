...
// Type: InfoGov.Plugins.Recaudacion.Reportes.BoletoAntenaGuay.irepBoletoAntenaGuay1
...
public class irepBoletoAntenaGuay1 : InfoGovReport
{
  ...
  public irepBoletoAntenaGuay1()
    : base(nameof (irepBoletoAntenaGuay1), "Boleto Antena")
  {
  ...
  {
    ((XtraReportBase) ((SubreportBase) this.xrSubreport1).ReportSource).DataSource = (object) ((DTOBoletoAntenaGuay) ((XtraReportBase) this).GetCurrentRow()).cupones;
  }
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (irepBoletoAntenaGuay1));
    ...
    {
      new ExpressionBinding("BeforePrint", "Text", "[DeudLianStr]")
    });
    ...
    ((XRControl) this.xrLabel11).Text = "Calle: [CallLian] Nro: [NucaLian] Barrio: [BarrLian] Mza: [ManzLian] Casa: [CasaLian][UbicLian]\r\nLoc: [LocaLian] CP: [CopoLian]";
    ...
    {
      new ExpressionBinding("BeforePrint", "Text", "[OrdeLian]")
    });
    ...
    ((XRControl) this.xrLabel3).Text = "TASAS DE ESTRUCTURAS DE ANTENA Y SUS EQUIPOS \nCOMPLEMENTARIOS";
    ...
    ((XRControl) this.xrLabel13).Text = "Calle: [CallLianReal] Nro: [NucaLianReal] Barrio: [BarrLianReal] Mza: [ManzLianReal]\r\nCasa: [CasaLianReal][UbicLianReal]\r\nLoc: [LocaLianReal] CP: [CopoLianReal]\r\n";
    ...
    ((SubreportBase) this.xrSubreport1).ReportSource = (XtraReport) new CuponesAntena();
    ((XRControl) this.xrSubreport1).SizeF = new SizeF(771.8741f, 23f);
    this.objectDataSource1.DataSource = (object) typeof (DTOBoletoAntenaGuay);
