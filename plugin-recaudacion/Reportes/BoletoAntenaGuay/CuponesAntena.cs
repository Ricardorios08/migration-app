...
// Type: InfoGov.Plugins.Recaudacion.Reportes.BoletoAntenaGuay.CuponesAntena
...
public class CuponesAntena : XtraReport
{
  ...
  public CuponesAntena() => this.InitializeComponent();
  ...
  private void InitializeComponent()
  {
    ...
    ((XRControl) this.TableDeta).LocationFloat = new PointFloat(1.030761f, 123.0417f);
    ...
    {
      new XRBinding("Text", (object) null, "FeveLian")
    });
    ...
    ((XRControl) this.xrTableCell8).Text = "C. EMISIÓN ";
    this.xrTableCell8.Weight = 2.1345407404535646;
    ...
    {
      new XRBinding("Text", (object) null, "ImpoLian")
    });
    ...
    {
      new XRBinding("Text", (object) null, "DescLian")
    });
    ...
    {
      new XRBinding("Text", (object) null, "CEmision")
    });
    ...
    {
      new XRBinding("Text", (object) null, "FeveLian", "{0:dd/MM/yyyy}")
    });
    ...
    ((XRControl) this.xrBarCode3).LocationFloat = new PointFloat(182.9372f, 69.12634f);
    ...
    ((XRControl) this.xrLabel24).LocationFloat = new PointFloat(168.621f, 112.0417f);
    ...
    this.ToltalP.Expression = "[ImpoLian] - [DescLian] + [RecaBole] + [CEmision]";
    this.ToltalP.Name = "ToltalP";
    this.objectDataSource1.DataSource = (object) typeof (CuponAntena);
