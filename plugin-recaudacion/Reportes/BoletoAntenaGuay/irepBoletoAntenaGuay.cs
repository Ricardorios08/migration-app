...
// Type: InfoGov.Plugins.Recaudacion.Reportes.BoletoAntenaGuay.irepBoletoAntenaGuay
...
public class irepBoletoAntenaGuay : InfoGovReport
{
  ...
  public irepBoletoAntenaGuay()
    : base(nameof (irepBoletoAntenaGuay), "Boleto Antena")
  {
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (irepBoletoAntenaGuay));
