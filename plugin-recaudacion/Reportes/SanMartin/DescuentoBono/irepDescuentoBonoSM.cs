...
// Type: InfoGov.Plugins.Recaudacion.Reportes.SanMartin.DescuentoBono.irepDescuentoBonoSM
...
public class irepDescuentoBonoSM : XtraReport
{
  ...
  public irepDescuentoBonoSM() => this.InitializeComponent();
