...
// Type: InfoGov.Plugins.Recaudacion.Reportes.Certificados.SanMartin.CertificadoExencion.irepCertExenSM
...
public class irepCertExenSM : InfoGovReport
{
  ...
  public irepCertExenSM()
    : base(nameof (irepCertExenSM), "Certificado de Exención")
  {
  ...
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (irepCertExenSM));
    ...
    ((XRControl) this.xrLabel3).Text = "San Martín, Mendoza";
    ...
    ((XRControl) this.PageHeader).Controls.AddRange(new XRControl[4]
    {
    ...
    ((XRControl) this.xrLabel4).Font = new Font("Calibri", 12f, FontStyle.Bold);
    ((XRControl) this.xrLabel4).LocationFloat = new PointFloat(241.4583f, 66.99999f);
    ((XRControl) this.xrLabel4).Name = "xrLabel4";
    ((XRControl) this.xrLabel4).Padding = new PaddingInfo(2, 2, 0, 0, 100f);
    ((XRControl) this.xrLabel4).SizeF = new SizeF(344.7917f, 23f);
    ((XRControl) this.xrLabel4).StylePriority.UseFont = false;
    ((XRControl) this.xrLabel4).StylePriority.UseTextAlignment = false;
    ((XRControl) this.xrLabel4).Text = "Sub Secretaría de Hacienda";
    ...
    ((XRControl) this.xrLabel2).Text = "Secretaría de Hacienda";
    ...
    this.Margins = new Margins(15, 8, 28, 11);
