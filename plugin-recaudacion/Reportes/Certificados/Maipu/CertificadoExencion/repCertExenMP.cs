...
// Type: InfoGov.Plugins.Recaudacion.Reportes.Certificados.Maipu.CertificadoExencion.repCertExenMP
...
public class repCertExenMP : InfoGovPrintForm
{
  private ExpInmuebleMP exp;
  ...
  public repCertExenMP()
    : base("Certificado de Exención")
  {
    this.InitializeComponent();
    this.exp = new ExpInmuebleMP();
  ...
  {
    return (InfoGovReport) new irepCertExenMP()
    {
  ...
  private void InitializeComponent()
  {
    ...
    this.Name = nameof (repCertExenMP);
    this.Text = nameof (repCertExenMP);
