...
// Type: InfoGov.Plugins.Contabilidad.Entidades.ParametroCierreEjercicio
...
public class ParametroCierreEjercicio : Entity
{
  public int PeriInfo { get; set; }

  public DateTime FedePaco { get; set; }

  public DateTime FemaxPaco { get; set; }
