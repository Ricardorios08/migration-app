...
// Type: InfoGov.Plugins.Contabilidad.Entidades.TipoAsiento
...
public class TipoAsiento : Entity
{
  public TipoAsiento() => this.DetaTias = "";

  public int CodiTias { get; set; }

  public string DetaTias { get; set; }

  public bool FijoTias { get; set; }

  public override ID id => new ID("CodiTias", (object) this.CodiTias);
}
