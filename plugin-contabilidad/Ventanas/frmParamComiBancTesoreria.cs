...
// Type: InfoGov.Plugins.Contabilidad.Ventanas.frmParamComiBancTesoreria
...
public class frmParamComiBancTesoreria : FRMForm, ObsPeriodo
{
  private BindingSource bsComiBancTesoreria = new BindingSource();
  private BindingSource bsComiBancTesoreriaRowSelected = new BindingSource();
  ...
  private GridColumn colDetaMoba;
  ...
  public frmParamComiBancTesoreria()
    : base("Parámetros Comisiones Bancarias", "Parámetros Comisiones Bancarias", typeof (ParamComiBancarias))
  {
    this.InitializeComponent();
    this.panel1.Visible = false;
    this.gridControl1.DataSource = (object) this.bsComiBancTesoreria;
    this.gridControl2.DataSource = (object) this.bsComiBancTesoreriaRowSelected;
    this.bsComiBancTesoreria.DataSource = (object) this.experto.formLoad();
    this.BtnComiBancarias.Enabled = false;
  }

  public void PeriodoChanged(int periodo) => this.Close();

  private void BtnComiBancarias_Click(object sender, EventArgs e)
  {
    ...
    {
      new frmMensaje(this.ParentForm).mostrarError("El Total de comisiones Tesorería es mayor al Saldo de la preventiva. Verifique...");
    }
    else
    {
      new frmMensaje(this.ParentForm).mostrarAdvertencia("Comienzan las imputaciones de las Comisiones Tesorería...");
      if (this.experto.ImputarComisionesBcriasTesoreria(pcb, DateTime.Parse(((Control) this.lblFechaDesde).Text), DateTime.Parse(((Control) this.lblFechaHasta).Text), ((Control) this.lblPagaImpu).Text, "1103110000"))
        new frmMensaje(this.ParentForm).mostrarConfirmación("Terminaron las imputaciones de las Comisiones Tesorería.");
      else
        new frmMensaje(this.ParentForm).mostrarErrorGrabarReq(this.Name.ToString(), this.experto.ToString(), "ImputarComisionesBcriasTesoreria");
    }
  }
  ...
  private void gridView1_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
  {
    ...
    if (row.MesPaco != 12)
    {
      ...
      dateTime1 = new DateTime(PARAMS.Periodo, row.MesPaco, 31 /*0x1F*/);
    ...
    if (PARAMS.MunicipioID == Municipio.Guaymallén)
      iCodiTimbComTes = 14;
    this.bsComiBancTesoreriaRowSelected.DataSource = (object) this.experto.getMoviBanco(iCodiTimbComTes, row.MesPaco, fechaDesde, FechaHasta);
    Decimal num = 0M;
    for (int index = 0; index < ((BaseView) this.gridView2).RowCount; ++index)
      num += Decimal.Parse(((ColumnView) this.gridView2).GetRowCellDisplayText(index, "HabeMoba"));
  ...
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (frmParamComiBancTesoreria));
    ...
    this.colDetaMoba = new GridColumn();
    ...
    this.SuspendLayout();
    this.panel1.Size = new Size(1239, 20);
    ...
    this.separator1.Size = new Size(19231, 2);
    ...
    ((Control) this.gridControl1).Size = new Size(535, 187);
    ...
    this.colCodiBanc.Caption = "Cod. Banco";
    ...
    this.colDetaBanc.Width = 242;
    this.colCodiTimb.Caption = "Cod. Tipo MB";
    ...
    this.colDetaTimb.Width = 249;
    this.colNumeMoba.Caption = "Mov. Banc. N°";
    ...
    this.colNumeMoba.Width = 82;
    this.colFechMoba.Caption = "Fecha Mov. Banc.";
    ...
    this.colDetaMoba.Caption = "Movimiento Bancario";
    this.colDetaMoba.FieldName = "DetaMoba";
    this.colDetaMoba.Name = "colDetaMoba";
    this.colDetaMoba.OptionsColumn.AllowEdit = false;
    this.colDetaMoba.Visible = true;
    this.colDetaMoba.VisibleIndex = 8;
    this.colDetaMoba.Width = 261;
    ...
    this.groupBox1.Size = new Size(698, 206);
    this.groupBox1.TabIndex = 4;
    this.groupBox1.TabStop = false;
    this.groupBox1.Text = "Imputar Comisiones Bancarias Tesorería ";
    ...
    ((Control) this.lblPagaImpu).TabIndex = 15;
    ...
    ((Control) this.labelControl4).TabIndex = 14;
    ...
    ((Control) this.lblFechaHasta).TabIndex = 13;
    ...
    ((Control) this.lblFechaDesde).TabIndex = 12;
    ...
    ((Control) this.labelControl1).TabIndex = 11;
    ...
    this.BtnComiBancarias.Size = new Size(217, 23);
    this.BtnComiBancarias.TabIndex = 10;
    this.BtnComiBancarias.Text = "Comisiones Bancarias Tesoreria";
    this.BtnComiBancarias.Click += new EventHandler(this.BtnComiBancarias_Click);
    this.metroLabel6.AutoSize = false;
    this.metroLabel6.Location = new Point(485, 58);
    this.metroLabel6.Name = "metroLabel6";
    this.metroLabel6.Size = new Size(129, 19);
    this.metroLabel6.TabIndex = 5;
    this.metroLabel6.Text = "Expediente original";
    ...
    this.metroPanel1.Location = new Point(0, 20);
    this.metroPanel1.Name = "metroPanel1";
    this.metroPanel1.Size = new Size(1239, 206);
    ...
    this.groupBox2.Size = new Size(541, 206);
    this.groupBox2.TabIndex = 5;
    this.groupBox2.TabStop = false;
    this.AutoScaleDimensions = new SizeF(6f, 13f);
    this.AutoScaleMode = AutoScaleMode.Font;
    this.ClientSize = new Size(1239, 522);
    this.Controls.Add((Control) this.metroPanel1);
    this.Controls.Add((Control) this.gridControl2);
    this.Name = nameof (frmParamComiBancTesoreria);
    this.Text = "Comisiones Tesoreria";
