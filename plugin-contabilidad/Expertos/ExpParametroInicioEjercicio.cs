...
// Type: InfoGov.Plugins.Contabilidad.Expertos.ExpParametroInicioEjercicio
...
public class ExpParametroInicioEjercicio : Expert, ABMExpert
{
  public ExpParametroInicioEjercicio()
  ...
  public List<Entity> getGridData(Filter filter)
  {
    ...
    {
      while (dr.Read())
        gridData.Add((Entity) this.readParametroInicioCierre(dr));
    }
    dr.Close();
    return gridData;
  }

  private ParametroInicioEjercicio readParametroInicioCierre(InfoGovReader dr)
  {
    return new ParametroInicioEjercicio()
    {
