...
// Type: InfoGov.Plugins.Infogov.Reportes.DatosFijos.Persona.DTOPersona
...
public class DTOPersona
{
  ...
  public DateTime FevaPers { get; set; }

  public string FevaPersStr
  {
    get => this.FevaPers == DateTime.MinValue ? "---" : this.FevaPers.ToShortDateString();
  }
}
